...
WIN_CheckAsyncMouseRelease( SDL_WindowData *data )
{
    ...
    */
    ...
    WIN_CheckWParamMouseButton( ( keyState & 0x8000 ), ( mouseFlags & SDL_BUTTON_LMASK ), data, SDL_BUTTON_LEFT, 0 );
    keyState = GetAsyncKeyState( VK_RBUTTON );
    WIN_CheckWParamMouseButton( ( keyState & 0x8000 ), ( mouseFlags & SDL_BUTTON_RMASK ), data, SDL_BUTTON_RIGHT, 0 );
    keyState = GetAsyncKeyState( VK_MBUTTON );
    WIN_CheckWParamMouseButton( ( keyState & 0x8000 ), ( mouseFlags & SDL_BUTTON_MMASK ), data, SDL_BUTTON_MIDDLE, 0 );
    keyState = GetAsyncKeyState( VK_XBUTTON1 );
    WIN_CheckWParamMouseButton( ( keyState & 0x8000 ), ( mouseFlags & SDL_BUTTON_X1MASK ), data, SDL_BUTTON_X1, 0 );
    keyState = GetAsyncKeyState( VK_XBUTTON2 );
    WIN_CheckWParamMouseButton( ( keyState & 0x8000 ), ( mouseFlags & SDL_BUTTON_X2MASK ), data, SDL_BUTTON_X2, 0 );
